...
function App() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      filterBtn?.forEach((btn) => btn.removeEventListener("click", filterFunc));
    };
  }, []);
        ...
        <div className="main-content">
          ...
          <article className="about  active" data-page="about">
            ...
            <section className="about-text">
              <p>
                I'm Creative Director, Cinematography, Content Creator & Digital
                Marketing from Nashik, India.
              </p>

              <p>
                As a Creative Director, my unique selling points (USPs) are a
                testament to my limitless imagination and out-of-the-box
                creativity. I possess the ability to craft visions that not only
                captivate but resonate with audiences on a deep level—visions
                that truly boom. My approach to problem-solving is streamlined
                and effective, allowing me to find easier solutions for complex
                challenges. With an arsenal of infinite ideas tailored to any
                situation, I excel at creating compelling business content that
                drives engagement. I have the remarkable skill to view a single
                product from 99 different perspectives, ensuring a fresh and
                comprehensive approach to every project. Most importantly, I am
                an execution maker and action taker, turning innovative concepts
                into reality with precision and impact.
              </p>
            </section>
